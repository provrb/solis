...
function TitleBar() {
  ...
  return (
    <div
      className="h-8 bg-white border-b border-slate-200 flex items-center justify-between pl-4 pr-2 select-none relative"
      style={{ WebkitAppRegion: "drag" } as React.CSSProperties}
    >
      {/* App Title - Left Aligned */}
      <div className="flex items-center pointer-events-none">
        <h1 className="text-sm font-semibold text-slate-600 font-montserrat">
          Solis
        </h1>
      </div>
